            ...
            <form method="POST" action="{{ route('posts.update', ['post' => $post->slug]) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                        name="title" placeholder="Enter title" value="{{ $post->title }}" required>
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="body" name="body" rows="5" placeholder="Enter body text" required> {{ $post->body }} </textarea>
                </div>
                <!-- Category ID -->
                <div class="mb-3">
